...
public class RoundAbout {
    public static void main(String[] args) {
        ...
        Condition T5Ct5 = new Condition(t5, "P5", TransitionCondition.NotNull);
        Condition T5Ct1 = new Condition(t5, "P1", TransitionCondition.CanAddCars);
        T5Ct5.SetNextCondition(LogicConnector.AND, T5Ct1);

        GuardMapping grdT5 = new GuardMapping();
        grdT5.condition= T5Ct5;
        ...
        Condition T6Ct6 = new Condition(t6, "P6", TransitionCondition.NotNull);
        Condition T6Ct2 = new Condition(t6, "P2", TransitionCondition.CanAddCars);
        T6Ct6.SetNextCondition(LogicConnector.AND, T6Ct2);

        GuardMapping grdT6 = new GuardMapping();
        grdT6.condition= T6Ct6;
        ...
        Condition T8Ct8 = new Condition(t8, "P8", TransitionCondition.NotNull);
        Condition T8Ct3 = new Condition(t8, "P3", TransitionCondition.CanAddCars);
        T8Ct8.SetNextCondition(LogicConnector.AND, T8Ct3);

        GuardMapping grdT8 = new GuardMapping();
        grdT8.condition= T8Ct8;
        ...
        Condition T1Ct5 = new Condition(t1, "P1", TransitionCondition.HaveCarForMe);
        Condition T2Ct1 = new Condition(t1, "P2",TransitionCondition.CanAddCars);
        T1Ct5.SetNextCondition(LogicConnector.AND, T2Ct1);

        GuardMapping grdT1 = new GuardMapping();
        grdT1.condition= T1Ct5;
        ...
        Condition T2Ct9 = new Condition(t2, "P2", TransitionCondition.HaveCarForMe);
        Condition T3Ct2 = new Condition(t2, "P3",TransitionCondition.CanAddCars);
        T2Ct9.SetNextCondition(LogicConnector.AND, T3Ct2);

        GuardMapping grdT2 = new GuardMapping();
        grdT2.condition= T2Ct9;
        ...
        Condition T3Ct4 = new Condition(t3, "P3", TransitionCondition.HaveCarForMe);
        Condition T4Ct1 = new Condition(t3, "P1",TransitionCondition.CanAddCars);
        T3Ct4.SetNextCondition(LogicConnector.AND, T4Ct1);

        GuardMapping grdT3 = new GuardMapping();
        grdT3.condition= T3Ct4;
        ...
        Condition T4Ct3 = new Condition(t4, "P1", TransitionCondition.HaveCarForMe);

        GuardMapping grdT4 = new GuardMapping();
        grdT4.condition= T4Ct3;
        ...
        Condition T9Ct2 = new Condition(t9, "P3", TransitionCondition.HaveCarForMe);

        GuardMapping grdT9 = new GuardMapping();
        grdT9.condition= T9Ct2;
