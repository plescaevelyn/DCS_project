...
public class LaneIntersection {
    public static void main(String[] args) {
        ...
        p26.SetName("P_o4n");
        p26.Value = new TransferOperation("localhost", "1081", "P5");
        ...
        grdT111.Activations.add(new Activation(t1, "Full", TransitionOperation.SendOverNetwork, "OP1"));
        grdT111.Activations.add(new Activation(t1, "P_a1", TransitionOperation.Copy, "P_a1"));
...
//		t2.Delay = 3;
        ...
        Condition T3Ct4 = new Condition(t3, "P_x12", TransitionCondition.CanNotAddCars);
        ...
        grdT31.Activations.add(new Activation(t3, "P_a2", TransitionOperation.Copy, "P_a2"));
        ...
        grdT51.Activations.add(new Activation(t5, "P_a3", TransitionOperation.Copy, "P_a3"));
        t1.GuardMappingList.add(grdT51);
        ...
        grdT71.Activations.add(new Activation(t7, "P_a4", TransitionOperation.Copy, "P_a4"));
        t7.GuardMappingList.add(grdT71);
        ...
        grdT21.Activations.add(new Activation(t21, "P_o4Exit", TransitionOperation.SendOverNetwork, "P_o4n"));
